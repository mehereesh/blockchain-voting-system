...
mydb=pymysql.connect(host='127.0.0.1', user='root', password='Meher@2901', port=3306, database='smart_voting_system')

sender_address = 'mrmarico2901@gmail.com' #enter sender's email id
sender_pass = 'Meher@2901' #enter sender's password
...
def voting():
    if request.method=='POST':
        ...
        recognizer.read(r"C:\blockchain-voting-projects-work\Smart-Voting-System\code\Trained.yml")
        cam=cv2.VideoCapture(0, cv2.CAP_DSHOW)
